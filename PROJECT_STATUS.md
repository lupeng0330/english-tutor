...
> 最后更新：**2026-06-29**（本次：PROJECT_STATUS.md 二次梳理——**铁律 6/7/8/9 完整定义上移并入 §0 与 1-5 并列形成 9 条单一信源权威；§32 简化为修订时间线**；速读卡当前线上改为"见 version.txt"指针避免每次手改；§3 当前规模 + §7 git log + §8 优先级全量同步到周末后真实数据）
...
| 时间 | 事件 | 详见 |
|---|---|---|
| 2026-06-29 | PROJECT_STATUS.md 二次梳理：铁律 6-9 上移并入 §0 与 1-5 并列（单一信源）；速读卡当前线上改为指针；§3/§7/§8 同步到周末后真实数据 | 本节 |
...
| 教材 | 状态 | 详情 |
|---|---|---|
| **教科版 jk** | ✅ 主力 | **82 个单元** —— 1-2 年级 8 个占位单元（每年级×2 学期×2 单元，10 词/册，待重做）；**3 上 → 6 上 共 7 册 63 单元**（每册 9 单元 / 70 词 / 18 课文，2024 秋新版）；6 下 11 单元真实（2014 旧版） |
...
| **P5** | jk 1-2 年级 + jk 6 下 重做为 2024 新版 | ~3-5 天 | 8 个占位单元 + 6 下 11 单元（当前 2014 旧版） |
