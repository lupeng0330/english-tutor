...
> 最后更新：2026-06-25（PC 端，新增：手机端例句语音修复 §21 + 沪教版例句补全开发计划 §8 P0.5）  
...
#### v01.13(例句) — 沪教版单词例句补全（📋 已确认开发计划，待开工）
...
| 初一下 | 7B | 120 | `hj_grade7_xia.json` | ❌ 待补（建议首批，验收节奏） |
| 初二上 | 8A | 120 | `hj_grade8_shang.json` | ❌ 待补 |
