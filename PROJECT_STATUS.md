...
> 最后更新：**2026-06-30 上午 · 已上线 V02.45**（本次：**P2-C 批次 2 · hj 全 6 册 36 篇 cloze**——批次 1 上线后立即追加 7B/8A/8B/9A/9B 共 30 篇短文 + 150 挖空（话题对齐教材 U1-U8 主题），hj_cloze.json 6→36 篇 / 30→180 挖空；纯数据填充无工程改动；详见 §36；上次：P2-C 批次 1 工程基建 V02.44）
...
| 时间 | 事件 | 详见 |
|---|---|---|
| 2026-06-29 深夜+ | **P2-C 批次 2 · hj 全 6 册 cloze**：追加 7B/8A/8B/9A/9B 共 30 篇 150 挖空；hj 完形 6→36 篇 / 30→180 挖空 | §36（附录 A） |
...
> ✅ **完形填空（P2-C 批次 1 + 2 完成）**：hj 全 6 册 36 篇短文 / 180 挖空，每篇 80-100 词连贯短文 + 5 个挖空，话题对齐教材。每册分布：7A 6 / 7B 6 / 8A 6 / 8B 6 / 9A 6 / 9B 6。详见 §36。下次会话可做批次 3（jk 小学 28 篇）。
...
| ⏳ **P2-C 进行中** | 完形填空独立题库：批次 1 + 2 完成（hj 全 6 册 36 篇 180 挖空），批次 3 jk 小学 28 篇待补 | §36 |

### 🎯 下一档可选任务（按用户偏好挑一项）

| 优先级 | 任务 | 预估 | 备注 |
|---|---|---|---|
| **P2-C 批次 3** | jk 小学完形填空 3 上→6 上 7 册 28 篇 | ~4 小时 | 写 `scripts/jk/build_cloze.py` + 28 篇短文 |
...
| jk 3 上→6 上 7 册 28 篇 ~140 挖空 | ⏳ 待启动 | 写 `scripts/jk/build_cloze.py` + 28 篇短文，~4 小时 |
