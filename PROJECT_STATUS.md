...
> 最后更新：**2026-07-30 · ✅🩹 智能推荐练习 + 错题本题目完整性修复已验收上线 `20260730V03.28`(§62)：连词成句/完成句子/听音判断已补齐专用交互，听音选图/填空补齐播放入口，整篇完形自动拆为逐空题；广州口语 A-D 答案与单字母拼写修复；错题本 16 类记录均有题干、答案和重练控件，结构化题目 ID 防碰撞，考试完形按空保存；智能推荐刷新不再出现 `undefined`。**
