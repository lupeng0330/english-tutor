...
> 最后更新：**2026-07-30 · ✅🖥️📱🔊 Phase 3.5 离线语音包已验收上线 `20260730V03.26`(§61)：18 册按册下载，覆盖 5581 个去重音频 + 对应教材/题库/例句/练习/考试数据；个人中心可看占用、续传、更新、按册/全部删除；音频与数据独立稳定缓存，断网整页启动及广州口语非默认教材实测通过；Capacitor 继续随安装包内置全部语音。下一站→Phase 4 管理后台**
...
| Phase 3.5 | 离线 TTS 方案 + 移动端音频随包/按需下载策略 | 全端 | ✅ **已验收上线 `20260730V03.26`**（18 册按需下载；5581 音频+教材/题库/例句/练习/考试数据自包含；断点续传/修订更新/存储管理；移动端随包，详见 §61） |
...
## 61. ✅ Phase 3.5 离线语音包 · 按册下载 + 自包含学习数据（2026-07-30，已验收上线 `20260730V03.26`）
...
- ✅ 已按铁律执行 `dev-push.ps1`，上线版本：`20260730V03.26`。
- 🌐 线上地址：<https://lupeng0330.github.io/english-tutor/?v=20260730V03.26>。
