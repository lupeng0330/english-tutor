...
> 最后更新：**2026-07-30 · ✅🖥️📱🔊 Phase 3.5 离线语音包已验收上线 `20260730V03.27`(§61)：18 册按册下载，覆盖 5581 个去重音频 + 对应教材/题库/例句/练习/考试数据；个人中心可看占用、续传、更新、按册/全部删除；音频与数据独立稳定缓存，断网整页启动及广州口语非默认教材实测通过；Capacitor 继续随安装包内置全部语音。下一站→Phase 4 管理后台**
